...
SPIClass::SPIClass(SERCOM *p_sercom, uint8_t uc_pinMISO, uint8_t uc_pinSCK, uint8_t uc_pinMOSI, SercomSpiTXPad PadTx, SercomRXPad PadRx, EPioType ul_PinType)
{
  initialized = false;
...
void SPIClass::begin()
{
  ...
  // PIO init
  pinPeripheral(_uc_pinMiso, (_ul_PinType == PIO_NOT_A_PIN) ? g_APinDescription[_uc_pinMiso].ulPinType : _ul_PinType);
  pinPeripheral(_uc_pinSCK, (_ul_PinType == PIO_NOT_A_PIN) ? g_APinDescription[_uc_pinSCK].ulPinType : _ul_PinType);
  pinPeripheral(_uc_pinMosi, (_ul_PinType == PIO_NOT_A_PIN) ? g_APinDescription[_uc_pinMosi].ulPinType : _ul_PinType);
...
void SPIClass::setClockSource(SercomClockSource clk) {
  ...
  #endif // PERIPH_SPI
  SPIClass SPI (&PERIPH_SPI,  PIN_SPI_MISO,  PIN_SPI_SCK,  PIN_SPI_MOSI,  PAD_SPI_TX,  PAD_SPI_RX, PORT_SPI_CONF);
#endif
#if SPI_INTERFACES_COUNT > 1
  SPIClass SPI1(&PERIPH_SPI1, PIN_SPI1_MISO, PIN_SPI1_SCK, PIN_SPI1_MOSI, PAD_SPI1_TX, PAD_SPI1_RX, PORT_SPI1_CONF);
#endif
#if SPI_INTERFACES_COUNT > 2
  SPIClass SPI2(&PERIPH_SPI2, PIN_SPI2_MISO, PIN_SPI2_SCK, PIN_SPI2_MOSI, PAD_SPI2_TX, PAD_SPI2_RX, PORT_SPI2_CONF);
#endif
#if SPI_INTERFACES_COUNT > 3
  SPIClass SPI3(&PERIPH_SPI3, PIN_SPI3_MISO, PIN_SPI3_SCK, PIN_SPI3_MOSI, PAD_SPI3_TX, PAD_SPI3_RX, PORT_SPI3_CONF);
#endif
#if SPI_INTERFACES_COUNT > 4
  SPIClass SPI4(&PERIPH_SPI4, PIN_SPI4_MISO, PIN_SPI4_SCK, PIN_SPI4_MOSI, PAD_SPI4_TX, PAD_SPI4_RX, PORT_SPI4_CONF);
#endif
#if SPI_INTERFACES_COUNT > 5
  SPIClass SPI5(&PERIPH_SPI5, PIN_SPI5_MISO, PIN_SPI5_SCK, PIN_SPI5_MOSI, PAD_SPI5_TX, PAD_SPI5_RX, PORT_SPI5_CONF);
#endif
