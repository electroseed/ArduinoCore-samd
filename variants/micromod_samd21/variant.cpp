...
const PinDescription g_APinDescription[] =
{
	...
	{PORTA,27,PIO_NOT_A_PIN,PIN_ATTR_DIGITAL,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_NONE}, 						// Not connected
	...
	{PORTA,4,PIO_ANALOG,0,ADC_Channel4,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_4}, 												// D15/A1 -  A1		- M38
	...
	{PORTA,5,PIO_ANALOG,0,ADC_Channel5,PWM0_CH1,NOT_ON_TIMER,EXTERNAL_INT_5},													// D20/A6 -  G0		- M40
	...
	{PORTB,11,PIO_SERCOM_ALT,PIN_ATTR_DIGITAL,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_11},							// D22 / Not analog	- M47
	{PORTA,3,PIO_ANALOG,PIN_ATTR_ANALOG,ADC_Channel1,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_3},									// D23/A9 -  D0		- M10
	{PORTB,10,PIO_SERCOM_ALT,PIN_ATTR_DIGITAL,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_10},							// D24 / Not analog	- M32
	{PORTB,2,PIO_ANALOG,0,ADC_Channel10,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_2}, 												// D25/A11 - D1		- M18
	{PORTB,8,PIO_ANALOG,(PIN_ATTR_PWM | PIN_ATTR_TIMER),ADC_Channel2,PWM4_CH0,TC4_CH0,EXTERNAL_INT_8},							// D26/A12 - G2		- M44
	{PORTB,9,PIO_ANALOG,(PIN_ATTR_PWM | PIN_ATTR_TIMER),ADC_Channel3,PWM4_CH1,TC4_CH1,EXTERNAL_INT_9},							// D27/A13 - G3		- M46
	{PORTB,3,PIO_SERCOM_ALT,PIN_ATTR_DIGITAL,ADC_Channel11,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_3},							// D28/A14 - G7		- M69
	{PORTA,10,PIO_SERCOM,(PIN_ATTR_DIGITAL),ADC_Channel18,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_10}, 							// D29/A15 - CS		- M55

	// 30..34	 Digital pins
	{PORTA,16,PIO_SERCOM,PIN_ATTR_NONE,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_NONE}, 								// D30 - AUD_BCLK	- M50
 	{PORTA,18,PIO_TIMER,(PIN_ATTR_DIGITAL | PIN_ATTR_PWM | PIN_ATTR_TIMER),No_ADC_Channel,PWM3_CH0,TC3_CH0,EXTERNAL_INT_2}, 	// D31 - CTS1		- M15
	{PORTA,19,PIO_TIMER_ALT,(PIN_ATTR_DIGITAL | PIN_ATTR_PWM | PIN_ATTR_TIMER_ALT),No_ADC_Channel,PWM0_CH3,TCC0_CH3,EXTERNAL_INT_3}, // D32 - RTS1	- M13
	{PORTA,30,PIO_PWM,PIN_ATTR_DIGITAL | PIO_SERCOM,No_ADC_Channel,NOT_ON_PWM,TCC1_CH0,EXTERNAL_INT_10}, 						// D33 - SWCLK		- M21
	{PORTA,31,PIO_PWM,PIN_ATTR_DIGITAL | PIO_SERCOM,No_ADC_Channel,NOT_ON_PWM,TCC1_CH1,EXTERNAL_INT_11}, 						// D34 - SWDIO		- M23
	{PORTB,22,PIO_SERCOM_ALT,(PIN_ATTR_DIGITAL | PIN_ATTR_PWM),No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_6}, 			// D35 - TX2		- M22
	{PORTB,23,PIO_SERCOM_ALT,(PIN_ATTR_DIGITAL | PIN_ATTR_PWM),No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_7},			// D36 - RX2		- M20

	// 37..38 - USB
	// --------------------
	{PORTA,24,PIO_COM,PIN_ATTR_NONE,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_NONE}, // USB/DM											- M5
	{PORTA,25,PIO_COM,PIN_ATTR_NONE,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_NONE}, // USB/DP											- M3
};
...
SERCOM sercom2(SERCOM2);			// I2C1 or SPI1
SERCOM sercom3(SERCOM3);			// I2C
SERCOM sercom4(SERCOM4);			// SPI Master or SPI Slave with A2 as SS
SERCOM sercom5(SERCOM5);			// Serial2

Uart Serial1(&sercom0, PIN_SERIAL1_RX, PIN_SERIAL1_TX, PAD_SERIAL1_RX, PAD_SERIAL1_TX, UPIO_SERCOM);
...
Uart Serial2(&sercom5, PIN_SERIAL2_RX, PIN_SERIAL2_TX, PAD_SERIAL2_RX, PAD_SERIAL2_TX, UPIO_SERCOM);
