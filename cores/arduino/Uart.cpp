...
Uart::Uart(SERCOM *_s, uint8_t _pinRX, uint8_t _pinTX, SercomRXPad _padRX, SercomUartTXPad _padTX, UartPioType _ul_PinType) :
  Uart(_s, _pinRX, _pinTX, _padRX, _padTX, NO_RTS_PIN, NO_CTS_PIN,_ul_PinType)
{
}

Uart::Uart(SERCOM *_s, uint8_t _pinRX, uint8_t _pinTX, SercomRXPad _padRX, SercomUartTXPad _padTX, uint8_t _pinRTS, uint8_t _pinCTS, UartPioType _ul_PinType)
{
  sercom = _s;
  uc_pinRX = _pinRX;
  uc_pinTX = _pinTX;
...
{
	pinPeripheral(uc_pinRX, (ul_PinType == UPIO_FROM_PIN_DESC) ? g_APinDescription[uc_pinRX].ulPinType : (EPioType)ul_PinType);
	pinPeripheral(uc_pinTX, (ul_PinType == UPIO_FROM_PIN_DESC) ? g_APinDescription[uc_pinTX].ulPinType : (EPioType)ul_PinType);
